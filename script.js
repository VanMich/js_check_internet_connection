...
const handlePopup = (status) => {
  ...
  popupDesc.innerHTML =
    "Your network is unavailable. We will attempt to recconect you in <b>10</b> seconds.";
  popup.className = "popup show";

  intervalId = setInterval(() => {
    // initialisation d'un interval pour decrementer le timer de chaque 1 seconde
    timer--;
